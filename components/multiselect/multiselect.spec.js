...
describe('MultiSelect', function () {
    ...
    it('should disabled', function () {
        ...
        var inputReadOnlyEl = fixture.debugElement.query(By.css('div')).nativeElement;
        containerEl.click();
        fixture.detectChanges();
    ...
    it('should get a name', function () {
        ...
        fixture.detectChanges();
        var inputReadOnlyEl = fixture.debugElement.query(By.css('.ui-helper-hidden-accessible')).children[0].nativeElement;
        expect(inputReadOnlyEl.name).toContain("PrimeNG");
    });
    it('should set dropdown icon by default and able to change', function () {
        fixture.detectChanges();
        var dropdownIcon = fixture.debugElement.query(By.css('.ui-multiselect-trigger-icon')).nativeElement;
    ...
    it('should change panelstyle and panelStyleClass', function () {
        ...
        fixture.detectChanges();
        var multiselectPanelEl = fixture.debugElement.query(By.css('.ui-multiselect-panel ')).nativeElement;
    ...
    it('should open when click', function () {
        ...
        multiselectEl.click();
        fixture.detectChanges();
        var multiselectPanelEl = fixture.debugElement.query(By.css('.ui-multiselect-panel'));
    ...
    it('should select item', function () {
        ...
        multiselectEl.click();
        fixture.detectChanges();
        var multiselectItemEl = fixture.debugElement.queryAll(By.css('.ui-multiselect-item'));
    ...
    it('should select all', function () {
        ...
        multiselectEl.click();
        fixture.detectChanges();
        var allCheckedEl = fixture.debugElement.query(By.css('.ui-chkbox-box')).nativeElement;
        var readOnlyEl = fixture.debugElement.query(By.css(".ui-chkbox")).children[0].children[0].nativeElement;
    ...
    it('should select all when filtered', function () {
        ...
        var multiselectEl = fixture.debugElement.children[0].nativeElement;
        var readOnlyEl = fixture.debugElement.query(By.css("input")).nativeElement;
        readOnlyEl.dispatchEvent(new Event('focus'));
        multiselectEl.click();
        fixture.detectChanges();
        readOnlyEl.dispatchEvent(new Event('blur'));
        var filterInputEl = fixture.debugElement.query(By.css('.ui-inputtext')).nativeElement;
    ...
    it('should close with close icon and reset filter input', function () {
        ...
        fixture.detectChanges();
        expect(multiselect.visibleOptions.length).toEqual(2);
        var closeEl = fixture.debugElement.query(By.css(".ui-multiselect-close"));
