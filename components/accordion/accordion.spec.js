...
describe('Accordion', function () {
    ...
    it('should change header', function () {
        ...
        fixture.detectChanges();
        var accordionTabHeaderEl = fixture.debugElement.children[0].children[0].children[0].query(By.css('.ui-accordion-header-text'));
    ...
    it('should have selected first accordionTab and second accordionTab should be unselected', function () {
        ...
        fixture.detectChanges();
        var firstAccordionTabHeaderEl = fixture.debugElement.children[0].children[0].children[0].query(By.css('.ui-accordion-header')).nativeElement;
        var secondAccordionTabHeaderEl = fixture.debugElement.children[0].children[0].children[1].query(By.css('.ui-accordion-header')).nativeElement;
    ...
    it('should have a multiple select and all accordionTabs should be selected', function () {
        ...
        fixture.detectChanges();
        var firstAccordionTabOpenEl = fixture.debugElement.children[0].children[0].children[0].query(By.css('a')).nativeElement;
        var secondAccordionTabOpenEl = fixture.debugElement.children[0].children[0].children[1].query(By.css('a')).nativeElement;
    ...
    it('should disabled', function () {
        ...
        fixture.detectChanges();
        var firstAccordionTabOpenEl = fixture.debugElement.children[0].children[0].children[0].query(By.css('a')).nativeElement;
        var accordionTabHeaderEl = fixture.debugElement.children[0].children[0].children[0].query(By.css('.ui-accordion-header')).nativeElement;
        firstAccordionTabOpenEl.click();
    ...
    it('should change expandIcon and collapseIcon', function () {
        ...
        fixture.detectChanges();
        var firstAccordionTabOpenEl = fixture.debugElement.children[0].children[0].children[0].query(By.css('.ui-accordion-toggle-icon')).nativeElement;
    ...
    it('should get styleClass', function () {
        ...
        fixture.detectChanges();
        var accordionEl = fixture.debugElement.children[0].query(By.css('.ui-accordion')).nativeElement;
    ...
    it('should be closed', fakeAsync(function () {
        fixture.detectChanges();
        var activeIndex;
        var secondAccordionTabOpenEl = fixture.debugElement.children[0].children[0].children[1].query(By.css('a')).nativeElement;
        accordion.onOpen.subscribe(function (value) { return activeIndex = value.index; });
