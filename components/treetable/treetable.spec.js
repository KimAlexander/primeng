...
describe('TreeTable', function () {
    ...
    it('should show 11 rows', function () {
        ...
        var basicTreeTableEl = fixture.debugElement.query(By.css(".basicTreeTable"));
        var rowEls = basicTreeTableEl.queryAll(By.css("tr"));
        var toggleEls = basicTreeTableEl.queryAll(By.css("p-treeTableToggler"));
    ...
    it('should expand first row', function () {
        ...
        var rowEls = basicTreeTableEl.queryAll(By.css("tr"));
        expect(rowEls.length).toEqual(11);
        var toggleEls = basicTreeTableEl.queryAll(By.css(".ui-treetable-toggler"));
    ...
    it('should create sections (caption footer summary)', function () {
        fixture.detectChanges();
        var basicTreeTableEl = fixture.debugElement.query(By.css(".basicTreeTable"));
        var captionEl = basicTreeTableEl.query(By.css(".ui-treetable-caption"));
        var summaryEl = basicTreeTableEl.query(By.css(".ui-treetable-summary"));
        var footerEl = basicTreeTableEl.query(By.css(".ui-treetable-tfoot"));
    ...
    it('should create paginator and 4 rows', function () {
        fixture.detectChanges();
        var paginationTreeTableEl = fixture.debugElement.query(By.css(".paginationTreeTable"));
        var rowEls = paginationTreeTableEl.queryAll(By.css("tr"));
        var paginatorEl = paginationTreeTableEl.query(By.css("p-paginator"));
        var pages = paginationTreeTableEl.queryAll(By.css(".ui-paginator-page"));
