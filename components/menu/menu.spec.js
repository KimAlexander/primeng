...
describe('Menu', function () {
    ...
    it('should display by default', function () {
        ...
        var containerEl = fixture.debugElement.query(By.css('.ui-menu'));
    ...
    it('should show items', function () {
        ...
        fixture.detectChanges();
        var itemsEl = fixture.debugElement.queryAll(By.css('a'));
    ...
    it('should not show items (menu visible false)', function () {
        ...
        fixture.detectChanges();
        var menuItemsEl = fixture.debugElement.queryAll(By.css('.ui-menuitem'));
    ...
    it('should show seperator', function () {
        ...
        fixture.detectChanges();
        var seperatorEl = fixture.debugElement.query(By.css('.ui-menu-separator'));
        var menuItemsEl = fixture.debugElement.queryAll(By.css('li'));
    ...
    it('should change target title icon and url', function () {
        ...
        fixture.detectChanges();
        var menuItemLink = fixture.debugElement.query(By.css('.ui-menuitem-link'));
        var iconEl = fixture.debugElement.query(By.css('.ui-menuitem-icon'));
    ...
    it('should use popup and call call toggle', function () {
        ...
        var popupButtonEl = fixture.debugElement.query(By.css('button'));
        popupButtonEl.nativeElement.click();
        fixture.detectChanges();
        var containerEl = fixture.debugElement.query(By.css('.ui-menu'));
        var headerEl = fixture.debugElement.query(By.css('.ui-submenu-header'));
        var menuItem = fixture.debugElement.query(By.css('.ui-menuitem-link'));
