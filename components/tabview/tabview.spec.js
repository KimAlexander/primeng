...
describe('TabView', function () {
    ...
    it('should change the orientation', function () {
        ...
        fixture.detectChanges();
        var tabPanelEl = fixture.debugElement.children[0].query(By.css('.ui-tabview')).nativeElement;
        var tabviewEl = fixture.debugElement.children[0].query(By.css('.ui-tabview')).nativeElement;
    ...
    it('should closable and element count should be 2', function () {
        ...
        fixture.detectChanges();
        var firstTabViewNavEl = fixture.debugElement.children[0].children[0].children[0].children[0].query(By.css('.ui-tabview-close')).nativeElement;
    ...
    it('should change left and right icon', function () {
        ...
        fixture.detectChanges();
        var firstTabViewLeftIconEl = fixture.debugElement.children[0].children[0].children[0].children[0].query(By.css('.ui-tabview-left-icon')).nativeElement;
        var firstTabViewRightIconEl = fixture.debugElement.children[0].children[0].children[0].children[0].query(By.css('.ui-tabview-right-icon')).nativeElement;
