...
describe('SlideMenu', function () {
    ...
    it('should created by default', function () {
        fixture.detectChanges();
        var containerEl = fixture.debugElement.query(By.css('.ui-slidemenu'));
        var slideMenuSubEl = fixture.debugElement.query(By.css('ul'));
    ...
    it('should change viewportHeight', function () {
        ...
        fixture.detectChanges();
        var wrapperEl = fixture.debugElement.query(By.css('.ui-slidemenu-wrapper'));
    ...
    it('should change backlabel', function () {
        ...
        fixture.detectChanges();
        var backwardSpanEl = fixture.debugElement.query(By.css('.ui-slidemenu-backward')).queryAll(By.css('span'))[1];
    ...
    it('should change menuWidth effectDuration and easing', function () {
        ...
        fixture.detectChanges();
        var slideMenuSubEl = fixture.debugElement.query(By.css('p-slideMenuSub')).query(By.css('ul'));
    ...
    it('should show items', function () {
        fixture.detectChanges();
        var firstSlidemenuSubEl = fixture.debugElement.query(By.css('p-slideMenuSub')).query(By.css('ul'));
        var itemsEl = fixture.debugElement.query(By.css('p-slideMenuSub')).queryAll(By.css('li'));
    ...
    it('should call itemClick when click and change menu from root to submenu', function () {
        fixture.detectChanges();
        var listsEl = fixture.debugElement.queryAll(By.css('ul'));
        var itemsEl = fixture.debugElement.query(By.css('p-slideMenuSub')).queryAll(By.css('li'));
        var fileItemEl = itemsEl[0].query(By.css('a'));
        var itemClickSpy = spyOn(slidemenuSub, 'itemClick').and.callThrough();
        fileItemEl.nativeElement.click();
        fixture.detectChanges();
        var activeItem = fixture.debugElement.query(By.css('.ui-menuitem-active'));
    ...
    it('should call goBack when click and change menu from subMenu to root', function () {
        ...
        fileItemEl.nativeElement.click();
        fixture.detectChanges();
        var backEl = fixture.debugElement.query(By.css('.ui-slidemenu-backward'));
    ...
    it('should click disabled item', function () {
        ...
        var itemsEl = fixture.debugElement.query(By.css('p-slideMenuSub')).queryAll(By.css('li'));
        var itemClickSpy = spyOn(slidemenuSub, 'itemClick').and.callThrough();
        var editItemEl = itemsEl[5].query(By.css('a'));
    ...
    it('should click item (command)', function () {
        fixture.detectChanges();
        var itemsEl = fixture.debugElement.query(By.css('p-slideMenuSub')).queryAll(By.css('li'));
        var newItemEl = itemsEl[1].query(By.css('a'));
        newItemEl.nativeElement.click();
        fixture.detectChanges();
        expect(slidemenu.left).toEqual(0);
        expect(slidemenuSub.activeItem).toEqual(undefined);
    });
    it('should open popup', fakeAsync(function () {
        fixture.detectChanges();
        ...
        fixture.detectChanges();
        var slideMenuEl = fixture.debugElement.query(By.css('.ui-slidemenu'));
        expect(slidemenu.visible).toEqual(true);
        expect(slideMenuEl).toBeTruthy();
    }));
    it('should use appendTo', fakeAsync(function () {
    ...
    it('should use appendTo with elemntRef', fakeAsync(function () {
