...
describe('Slider', function () {
    ...
    it('should created by default', function () {
        ...
        var sliderEl = fixture.debugElement.query(By.css('div')).nativeElement;
    ...
    it('should disabled', function () {
        ...
        var spanEl = fixture.debugElement.query(By.css(".ui-slider-handle"));
    ...
    it('should set min', function () {
        ...
        fixture.detectChanges();
        var spanEl = fixture.debugElement.query(By.css('span')).nativeElement;
    ...
    it('should select range', function () {
        ...
        fixture.detectChanges();
        var sliderHandlers = fixture.debugElement.queryAll(By.css(".ui-slider-handle"));
