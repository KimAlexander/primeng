...
describe('AutoComplete', function () {
    ...
    it('should disabled', function () {
        ...
        fixture.detectChanges();
        var inputDefaultEl = fixture.debugElement.query(By.css('input')).nativeElement;
        expect(inputDefaultEl.disabled).toEqual(true);
        fixture.detectChanges();
        autocomplete.multiple = true;
        autocomplete.disabled = true;
        fixture.detectChanges();
        var inputMultipleEl = fixture.debugElement.query(By.css('ul')).query(By.css('input'));
        var multiContainer = fixture.debugElement.query(By.css('ul'));
    ...
    it('should display dropdown icon', function () {
        ...
        fixture.detectChanges();
        var autocompleteEl = fixture.debugElement.query(By.css('span')).nativeElement;
        var dropdownIconEl = fixture.debugElement.query(By.css('.ui-autocomplete-dropdown')).nativeElement;
    ...
    it('should change style and styleClass', function () {
        ...
        autocomplete.multiple = true;
        fixture.detectChanges();
        var inputMultipleEl = fixture.debugElement.query(By.css('ul')).query(By.css('input')).nativeElement;
    ...
    it('should show filtered brands and change autoZIndex', fakeAsync(function () {
        autocomplete.autoZIndex = false;
        fixture.detectChanges();
        var focusValue;
        autocomplete.onFocus.subscribe(function (value) { return focusValue = value; });
        var inputEl = fixture.debugElement.query(By.css('.ui-inputtext.ui-widget'));
        ...
        tick(300);
        fixture.detectChanges();
        var suggestionsEls = fixture.debugElement.queryAll(By.css('li'));
    ...
    it('should change immutable and scrollHeight', fakeAsync(function () {
        autocomplete.immutable = false;
        autocomplete.scrollHeight = "450px";
        fixture.detectChanges();
        var deleteLastEl = fixture.debugElement.query(By.css('a'));
        ...
        fixture.detectChanges();
        var suggestionsEls = fixture.debugElement.queryAll(By.css('li'));
        var panelEl = fixture.debugElement.query(By.css('div'));
    ...
    it('should change appendTo', fakeAsync(function () {
    ...
    it('should change appendTo(2)', fakeAsync(function () {
    ...
    it('should not show panel', fakeAsync(function () {
        fixture.detectChanges();
        var inputEl = fixture.debugElement.query(By.css('.ui-inputtext.ui-widget'));
        inputEl.nativeElement.dispatchEvent(new Event('focus'));
        inputEl.nativeElement.focus();
    ...
    it('should show emptyMessage', fakeAsync(function () {
    ...
    it('should use autoHighlight', fakeAsync(function () {
        ...
        tick(300);
        fixture.detectChanges();
        var firstItemEl = fixture.debugElement.query(By.css('li')).nativeElement;
        expect(firstItemEl.className).toContain('ui-state-highlight');
    }));
    it('should use forceSelection', fakeAsync(function () {
    ...
    it('should select item', fakeAsync(function () {
        fixture.detectChanges();
        var inputEl = fixture.debugElement.query(By.css('.ui-inputtext.ui-widget'));
        inputEl.nativeElement.dispatchEvent(new Event('focus'));
        inputEl.nativeElement.focus();
    ...
    it('should show panel with dropdown', function () {
        ...
        var dropdownOpenEl = fixture.debugElement.query(By.css('.ui-autocomplete-dropdown'));
    ...
    it('should use field', fakeAsync(function () {
        autocomplete2.field = "brand";
        autocomplete2.forceSelection = true;
        fixture.detectChanges();
        var inputEl = fixture.debugElement.queryAll(By.css('p-autoComplete'))[1].query(By.css('.ui-inputtext.ui-widget'));
        inputEl.nativeElement.dispatchEvent(new Event('focus'));
        inputEl.nativeElement.focus();
        inputEl.nativeElement.click();
        fixture.detectChanges();
        ...
        tick(300);
        fixture.detectChanges();
        var firstItemEl = fixture.debugElement.queryAll(By.css('p-autoComplete'))[1].query(By.css('li')).nativeElement;
        firstItemEl.click();
        fixture.detectChanges();
    ...
    it('should change minLength', fakeAsync(function () {
    ...
    it('should multiple', function () {
        autocomplete.multiple = true;
        fixture.detectChanges();
        var spanEl = fixture.debugElement.query(By.css('span'));
        var listEl = fixture.debugElement.query(By.css('ul'));
    ...
    it('should select item with multiSelect', fakeAsync(function () {
        autocomplete.multiple = true;
        autocomplete.forceSelection = true;
        fixture.detectChanges();
        ...
        fixture.detectChanges();
        inputEl.nativeElement.dispatchEvent(new Event('change'));
        var firstItemEl = fixture.debugElement.queryAll(By.css('li'))[1].nativeElement;
        firstItemEl.click();
        fixture.detectChanges();
    ...
    it('should select selected item', fakeAsync(function () {
        autocomplete.multiple = true;
        fixture.detectChanges();
        var inputEl = fixture.debugElement.query(By.css('input'));
        inputEl.nativeElement.dispatchEvent(new Event('focus'));
    ...
    it('should delete item with backspace', fakeAsync(function () {
        autocomplete.multiple = true;
        fixture.detectChanges();
        var inputEl = fixture.debugElement.query(By.css('input'));
        inputEl.nativeElement.dispatchEvent(new Event('focus'));
    ...
    it('should delete item with icon', fakeAsync(function () {
        autocomplete.multiple = true;
        fixture.detectChanges();
        var inputEl = fixture.debugElement.query(By.css('input'));
        inputEl.nativeElement.dispatchEvent(new Event('focus'));
        ...
        expect(selectItemSpy).toHaveBeenCalled();
        expect(testComponent.brand).toEqual(autocomplete.value);
        var iconEl = fixture.debugElement.query(By.css('.ui-autocomplete-token-icon'));
