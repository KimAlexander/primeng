...
describe('Calendar', function () {
    ...
    it('should created by default', function () {
        ...
        var calenderEl = fixture.debugElement.query(By.css('span'));
    ...
    it('should change inputStyleClass', function () {
        ...
        fixture.detectChanges();
        var calenderEl = fixture.debugElement.query(By.css('input'));
        expect(calenderEl.nativeElement.className).toContain("Primeng ROCKS!");
    });
    ...
    it('should spanish', function () {
        ...
        inputEl.dispatchEvent(focusEvent);
        fixture.detectChanges();
        var firstDayEl = fixture.debugElement.query(By.css('.ui-datepicker-month'));
    ...
    it('should select next month and call navForward', function () {
        ...
        var monthEl = fixture.debugElement.query(By.css('.ui-datepicker-month'));
        expect(monthEl.nativeElement.textContent).toEqual(calendar.locale.monthNames[calendar.currentMonth]);
        var nextMonthEl = fixture.debugElement.query(By.css('.ui-datepicker-next'));
        nextMonthEl.nativeElement.click();
        fixture.detectChanges();
        var currentMonthEl = fixture.debugElement.query(By.css('.ui-datepicker-month'));
    ...
    it('should select pre month and call navBackward', function () {
        ...
        var monthEl = fixture.debugElement.query(By.css('.ui-datepicker-month'));
        expect(monthEl.nativeElement.textContent).toEqual(calendar.locale.monthNames[calendar.currentMonth]);
        var preMonthEl = fixture.debugElement.query(By.css('.ui-datepicker-prev'));
    ...
    it('should select date when click', fakeAsync(function () {
        ...
        var calendarContainer = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var sampleDateEls = calendarContainer.queryAll(By.css('a'));
        expect(calendar.dateTemplate).toBeFalsy();
        sampleDateEls[7].nativeElement.click();
        fixture.detectChanges();
        var datesEl = calendarContainer.queryAll(By.css('a'));
        var selectedTdEl = fixture.debugElement.query(By.css('.ui-datepicker-current-day'));
    ...
    it('should change date format', function () {
        ...
        var onDateSelectSpy = spyOn(calendar, 'onDateSelect').and.callThrough();
        var calendarContainer = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var sampleDateEl = calendarContainer.queryAll(By.css('a'))[4].nativeElement;
        sampleDateEl.click();
        fixture.detectChanges();
        expect(calendar.inputFieldValue).toEqual(inputEl.value);
    ...
    it('should use min and max date', function () {
        ...
        nextMonthEl.nativeElement.click();
        fixture.detectChanges();
        var containerEl = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var unselectableEls = containerEl.queryAll(By.css('.ui-state-default.ui-state-disabled'));
    ...
    it('should use year and month navigator', function () {
        ...
        inputEl.dispatchEvent(focusEvent);
        fixture.detectChanges();
        var navigators = fixture.debugElement.query(By.css('.ui-datepicker-title')).queryAll(By.css('select'));
        ...
        var datesContainer = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var dates = datesContainer.queryAll(By.css('a'));
    ...
    it('should show time', function () {
        ...
        var navigators = fixture.debugElement.query(By.css('.ui-datepicker-title')).queryAll(By.css('select'));
        var timers = fixture.debugElement.query(By.css('.ui-timepicker')).queryAll(By.css('div'));
    ...
    it('should only time', function () {
        ...
        var panelEl = fixture.debugElement.query(By.css('div')).nativeElement;
    ...
    it('should select today and clear input with button bar', fakeAsync(function () {
        ...
        var buttonbar = fixture.debugElement.query(By.css('.ui-datepicker-buttonbar'));
        var todayButtonEl = buttonbar.queryAll(By.css('button'))[0];
        var clearButtonEl = buttonbar.queryAll(By.css('button'))[1];
    ...
    it('should show multiple months', function () {
        ...
        fixture.detectChanges();
        var panelEl = fixture.debugElement.query(By.css('div'));
        var contentEls = fixture.debugElement.queryAll(By.css('.ui-datepicker-group'));
        var selectEls = fixture.debugElement.queryAll(By.css('select'));
    ...
    it('should show month picker', fakeAsync(function () {
        calendar.view = "month";
        ...
        inputEl.click();
        inputEl.dispatchEvent(focusEvent);
        var dateViewEl = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        fixture.detectChanges();
        var onMonthSelectSpy = spyOn(calendar, 'onMonthSelect').and.callThrough();
        var panelEl = fixture.debugElement.query(By.css('div')).nativeElement;
        var monthpickerEl = fixture.debugElement.query(By.css('.ui-monthpicker'));
        var janEl = monthpickerEl.query(By.css('a')).nativeElement;
    ...
    it('should use touchUI', fakeAsync(function () {
        ...
        var panelEl = fixture.debugElement.query(By.css('div')).nativeElement;
        var containerEl = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var firstDayEl = containerEl.query(By.css('a')).nativeElement;
    ...
    it('should select date with keyboardEvent', function () {
        ...
        fixture.detectChanges();
        var containerEl = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var firstEl = containerEl.query(By.css('a')).nativeElement;
        var monthSpanEl = fixture.debugElement.query(By.css('.ui-datepicker-month')).nativeElement;
        var yearSpanEl = fixture.debugElement.query(By.css('.ui-datepicker-year')).nativeElement;
    ...
    it('should listen onselect', function () {
        ...
        fixture.detectChanges();
        var calendarContainer = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var sampleDateEl = calendarContainer.queryAll(By.css('a'))[7].nativeElement;
        sampleDateEl.click();
        fixture.detectChanges();
    ...
    it('should show hourFormat', function () {
        ...
        fixture.detectChanges();
        var amPmEl = fixture.debugElement.query(By.css('.ui-ampm-picker'));
        var hourPicker = fixture.debugElement.query(By.css('.ui-hour-picker'));
        var minutePicker = fixture.debugElement.query(By.css('.ui-minute-picker'));
    ...
    it('should change hourFormat', function () {
        ...
        var amPmEl = fixture.debugElement.query(By.css('.ui-ampm-picker'));
        var hourPicker = fixture.debugElement.query(By.css('.ui-hour-picker'));
        var incrementHour = hourPicker.query(By.css('a'));
        var decrementHour = hourPicker.queryAll(By.css('a'))[1];
    ...
    it('should change hourFormat with ampm buttons', function () {
        ...
        var hourPicker = fixture.debugElement.query(By.css('.ui-hour-picker'));
        var minutePicker = fixture.debugElement.query(By.css('.ui-minute-picker'));
        var changeFormatEl = amPmEl.query(By.css('a'));
    ...
    it('should set defaultDate', function () {
        ...
        var hourPicker = fixture.debugElement.query(By.css('.ui-hour-picker'));
        var minutePicker = fixture.debugElement.query(By.css('.ui-minute-picker'));
        var yearEl = fixture.debugElement.query(By.css('.ui-datepicker-year'));
        var monthEl = fixture.debugElement.query(By.css('.ui-datepicker-month'));
        expect(hourPicker.children[2].nativeElement.textContent).toEqual('11');
        expect(minutePicker.children[2].nativeElement.textContent).toEqual('12');
    ...
    it('should show seconds', function () {
        ...
        inputEl.nativeElement.dispatchEvent(focusEvent);
        fixture.detectChanges();
        var seperatorEl = fixture.debugElement.queryAll(By.css('.ui-separator'));
        var secondPicker = fixture.debugElement.query(By.css('.ui-second-picker'));
    ...
    it('should change seconds', function () {
        ...
        fixture.detectChanges();
        var secondPicker = fixture.debugElement.query(By.css('.ui-second-picker'));
        var incrementSecond = secondPicker.query(By.css('a'));
        var decrementSecond = secondPicker.queryAll(By.css('a'))[1];
    ...
    it('should change stepSecond stepHour and stepMinute', function () {
        ...
        var decrementHour = hourPicker.queryAll(By.css('a'))[1];
        var minutePicker = fixture.debugElement.query(By.css('.ui-minute-picker'));
        var incrementMinute = minutePicker.query(By.css('a'));
        var decrementMinute = minutePicker.queryAll(By.css('a'))[1];
        incrementHour.nativeElement.dispatchEvent(new Event('mousedown'));
        incrementHour.nativeElement.dispatchEvent(new Event('mouseup'));
    ...
    it('should change showOnFocus', function () {
        ...
        inputEl.nativeElement.dispatchEvent(focusEvent);
        fixture.detectChanges();
        var panelEl = fixture.debugElement.query(By.css('.ui-datepicker'));
    ...
    it('should disabled(inline true)', function () {
        ...
        calendar.inline = true;
        fixture.detectChanges();
        var datePicker = fixture.debugElement.query(By.css('.ui-datepicker'));
    ...
    it('should change showOtherMonths', function () {
        ...
        var datesContainer = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var dates = datesContainer.queryAll(By.css('a'));
        var otherMonthDates = datesContainer.queryAll(By.css('.ui-datepicker-other-month'));
    ...
    it('should change hideOnDateTimeSelect', fakeAsync(function () {
    ...
    it('should be previous year', function () {
        ...
        var monthEl = fixture.debugElement.query(By.css('.ui-datepicker-month'));
        expect(monthEl.nativeElement.textContent).toEqual(calendar.locale.monthNames[calendar.currentMonth]);
        var prevMonthEl = fixture.debugElement.query(By.css('.ui-datepicker-prev'));
    ...
    it('should change yearRange', function () {
        ...
        inputEl.dispatchEvent(focusEvent);
        fixture.detectChanges();
        var yearSelectEl = fixture.debugElement.query(By.css('.ui-datepicker-year'));
        var yearsEls = yearSelectEl.queryAll(By.css('option'));
    ...
    it('should select range (touchUI)', function () {
        ...
        var containerEl = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var firstDayEl = containerEl.query(By.css('a')).nativeElement;
        var thirdDayEl = containerEl.queryAll(By.css('a'))[2].nativeElement;
        expect(panelEl.className).toContain("ui-datepicker-touch-ui");
        firstDayEl.click();
        fixture.detectChanges();
        thirdDayEl.click();
    ...
    it('should select range (touchUI third times)', function () {
        ...
        var containerEl = fixture.debugElement.query(By.css('.ui-datepicker-calendar-container'));
        var firstDayEl = containerEl.query(By.css('a')).nativeElement;
        var secondDayEl = containerEl.queryAll(By.css('a'))[1].nativeElement;
        var thirdDayEl = containerEl.queryAll(By.css('a'))[2].nativeElement;
        expect(panelEl.className).toContain("ui-datepicker-touch-ui");
        firstDayEl.click();
        fixture.detectChanges();
    ...
    it('should call navForward and pick the next year', function () {
        ...
        var decrementYearSpy = spyOn(calendar, 'decrementYear').and.callThrough();
        fixture.detectChanges();
        var navForwardEl = fixture.debugElement.query(By.css('.ui-datepicker-next'));
        var navBackwardEl = fixture.debugElement.query(By.css('.ui-datepicker-prev'));
