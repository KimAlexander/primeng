...
describe('Chips', function () {
    ...
    it('should display by default', function () {
        ...
        var chipsEl = fixture.debugElement.query(By.css('div'));
    ...
    it('should disabled', function () {
        ...
        var inputEl = fixture.debugElement.query(By.css('input'));
        var tokenIconEl = fixture.debugElement.query(By.css('.ui-chips-token-icon'));
    ...
    it('should use field varaible', function () {
        ...
        fixture.detectChanges();
        var labelEl = fixture.debugElement.query(By.css('.ui-chips-token-label'));
