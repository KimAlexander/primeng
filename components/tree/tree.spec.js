...
describe('Tree', function () {
    ...
    it('should created', function () {
        ...
        var treeEl = fixture.debugElement.query(By.css('.ui-tree'));
        expect(treeEl.nativeElement).toBeTruthy();
    });
    it('should call toggle and expand clicked row', function () {
        fixture.detectChanges();
        var toggleEls = fixture.debugElement.queryAll(By.css('.ui-tree-toggler'));
        var documentsToggleEl = toggleEls[0];
        var treeNodes = fixture.debugElement.queryAll(By.css("p-treeNode"));
    ...
    it('should focused with nav keys', function () {
        fixture.detectChanges();
        var contentEls = fixture.debugElement.queryAll(By.css('.ui-treenode-content'));
        ...
        fixture.detectChanges();
        var secondNode = fixture.debugElement.queryAll(By.css('.ui-treenode-content'))[1];
        ...
        fixture.detectChanges();
        var firstNode = fixture.debugElement.queryAll(By.css('.ui-treenode-content'))[0];
        ...
        fixture.detectChanges();
        var thirdNode = fixture.debugElement.queryAll(By.css('.ui-treenode-content'))[2];
        focusElement = document.activeElement;
    ...
    it('should be filtered', function () {
        tree.filter = true;
        fixture.detectChanges();
        var filterInput = fixture.debugElement.query(By.css('.ui-tree-filter'));
    ...
    it('should drop item from files to server2', function () {
        fixture.detectChanges();
        var fileTreeContentEls = fixture.debugElement.children[2].queryAll(By.css('.ui-treenode-content'));
        ...
        var fileTreeEl = fixture.debugElement.children[2].query(By.css('div'));
        var server2TreeEl = fixture.debugElement.children[4].query(By.css('div'));
        ...
        var server2DropPoints = server2TreeEl.queryAll(By.css('.ui-treenode-droppoint'));
        var serverContentEl = server2TreeEl.query(By.css('.ui-treenode-content'));
