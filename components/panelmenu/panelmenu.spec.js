...
describe('PanelMenu', function () {
    ...
    it('should display by default', function () {
        ...
        var panelMenuEl = fixture.debugElement.query(By.css('.ui-panelmenu'));
    ...
    it('should change item visible ', function () {
        ...
        fixture.detectChanges();
        var panelEl = fixture.debugElement.query(By.css('.ui-panelmenu-panel'));
    ...
    it('should change item style styleClass and disable ', function () {
        ...
        fixture.detectChanges();
        var panelHeaderEl = fixture.debugElement.query(By.css('.ui-panelmenu-header'));
    ...
    it('should change item url target item and title', function () {
        ...
        fixture.detectChanges();
        var panelHeaderLinkEl = fixture.debugElement.query(By.css('.ui-panelmenu-header-link'));
    ...
    it('should change child style and styleClass', function () {
        ...
        fixture.detectChanges();
        var menuItemLinks = fixture.debugElement.queryAll(By.css('.ui-menuitem'));
    ...
    it('should change child url target icon disabled and title', function () {
        ...
        fixture.detectChanges();
        var panelHeaderLinkEl = fixture.debugElement.query(By.css('.ui-menuitem-link'));
        expect(panelHeaderLinkEl.nativeElement.href).toContain('primeng');
        expect(panelHeaderLinkEl.nativeElement.title).toEqual('primeng');
        expect(panelHeaderLinkEl.nativeElement.target).toEqual('primeng');
        expect(panelHeaderLinkEl.query(By.css('.ui-menuitem-icon')).nativeElement.className).toContain("Primeng ROCKS!");
    ...
    it('should show items and call toggle', function () {
        ...
        var headerLinks = fixture.debugElement.queryAll(By.css('.ui-panelmenu-header-link'));
        expect(headerLinks.length).toEqual(2);
        headerLinks[0].nativeElement.click();
        fixture.detectChanges();
        var iconSpanEl = fixture.debugElement.query(By.css('.ui-panelmenu-icon'));
        var firstSubMenuComponent = fixture.debugElement.query(By.css('.ui-panelmenu-root-submenu')).componentInstance;
    ...
    it('should select multiple', function () {
        ...
        fixture.detectChanges();
        var subMenuEls = fixture.debugElement.queryAll(By.css('.ui-panelmenu-root-submenu'));
        var firstSubMenuComponent = subMenuEls[0].componentInstance;
        var seconSubMenuComponent = subMenuEls[1].componentInstance;
        var activeEls = fixture.debugElement.queryAll(By.css('.ui-state-active'));
