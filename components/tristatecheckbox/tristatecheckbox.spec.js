...
describe('TriStateCheckbox', function () {
    ...
    it('should created by default', function () {
        ...
        var tristatecheckboxEl = fixture.debugElement.query(By.css('div'));
    ...
    it('should disabled', function () {
        ...
        var helperInputEl = fixture.debugElement.query(By.css('.ui-helper-hidden-accessible')).children[0].nativeElement;
        var checkBoxEl = fixture.debugElement.query(By.css('.ui-chkbox-box')).nativeElement;
        var labelEl = fixture.debugElement.query(By.css('label')).nativeElement;
        checkBoxEl.click();
        fixture.detectChanges();
    ...
    it('should change stlye and styleClass', function () {
        ...
        fixture.detectChanges();
        var tristatecheckboxEl = fixture.debugElement.query(By.css('div')).nativeElement;
    ...
    it('should get a name inputId and tabIndex', function () {
        ...
        fixture.detectChanges();
        var helperInputEl = fixture.debugElement.query(By.css('input')).nativeElement;
        var labelEl = fixture.debugElement.query(By.css('label')).nativeElement;
    ...
    it('should value is true when click and listen onChange', function () {
        ...
        var checkBoxEl = fixture.debugElement.query(By.css('.ui-chkbox-box')).nativeElement;
        var checkBoxIconEl = fixture.debugElement.query(By.css('span')).nativeElement;
        var labeEl = fixture.debugElement.query(By.css('label')).nativeElement;
        checkBoxEl.click();
        fixture.detectChanges();
    ...
    it('should call onFocus', function () {
        ...
        var checkBoxEl = fixture.debugElement.query(By.css('.ui-chkbox-box'));
