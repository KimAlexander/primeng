...
describe('FileUpload', function () {
    ...
    it('should display by default (basic)', function () {
        ...
        var fileuploadEl = fixture.debugElement.query(By.css('span'));
    ...
    it('should display by default (advanced)', function () {
        fixture.detectChanges();
        var fileuploadEl = fixture.debugElement.query(By.css('div'));
        expect(fileuploadEl).toBeTruthy();
    ...
    it('should change style, styleClass, chooseLabel, uploadLabel, cancelLabel, showUploadButton and showCancelButton (advanced)', function () {
        ...
        fixture.detectChanges();
        var fileuploadEl = fixture.debugElement.query(By.css('div'));
        var uploadButton = fixture.debugElement.queryAll(By.css('button'))[0];
        var cancelButton = fixture.debugElement.queryAll(By.css('button'))[1];
        var chooseButton = fixture.debugElement.query(By.css(".ui-fileupload-choose"));
        expect(fileuploadEl).toBeTruthy();
    ...
    it('should call onFileSelect (advanced)', function () {
        ...
        var uploadButton = fixture.debugElement.queryAll(By.css('button'))[0];
        var cancelButton = fixture.debugElement.queryAll(By.css('button'))[1];
        var fileUploadRow = fixture.debugElement.query(By.css('.ui-fileupload-row'));
        var fileNameEl = fileUploadRow.children[1];
        var fileSizeEl = fileUploadRow.children[2];
        var removeButtonEl = fileUploadRow.query(By.css('button'));
    ...
    it('should call onDrageEnter onDragLeave onDrop and onFileSelect (advanced)', function () {
        ...
        fixture.detectChanges();
        var contentEl = fixture.debugElement.query(By.css(".ui-fileupload-content"));
