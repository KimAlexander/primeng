...
describe('Dropdown', function () {
    ...
    it('should disabled', function () {
        ...
        var containerEl = fixture.debugElement.query(By.css('.ui-dropdown')).nativeElement;
        var hiddenEl = fixture.debugElement.queryAll(By.css('.ui-helper-hidden-accessible'))[0].children[0].nativeElement;
        var editableInputEl = fixture.debugElement.queryAll(By.css('input'))[1].nativeElement;
    ...
    it('should change dropdown icon', function () {
        ...
        fixture.detectChanges();
        var dropdownSpanEl = fixture.debugElement.query(By.css('.ui-dropdown-trigger-icon.ui-clickable')).nativeElement;
    ...
    it('should change style and styleClass', function () {
        ...
        fixture.detectChanges();
        var containerEl = fixture.debugElement.query(By.css('.ui-dropdown'));
    ...
    it('should change panelStyleClass', function () {
        ...
        var container = fixture.debugElement.query(By.css('div')).nativeElement;
        container.click();
        fixture.detectChanges();
        var dropdownPanel = fixture.debugElement.query(By.css('.ui-dropdown-panel'));
    ...
    it('should open when clicked', function () {
        ...
        fixture.detectChanges();
        var container = fixture.debugElement.query(By.css('.ui-dropdown')).nativeElement;
        container.click();
        fixture.detectChanges();
        var dropdownPanel = fixture.debugElement.query(By.css('.ui-dropdown-panel'));
    ...
    it('should item selected', function () {
        ...
        container.click();
        fixture.detectChanges();
        var items = fixture.debugElement.query(By.css('.ui-dropdown-items'));
    ...
    it('should item clear', function () {
        ...
        items.children[2].children[0].nativeElement.click();
        fixture.detectChanges();
        var itemCloseIcon = fixture.debugElement.query(By.css('.ui-dropdown-clear-icon'));
    ...
    it('should filtered', async(function () {
        dropdown.options = [
        ...
        container.click();
        fixture.detectChanges();
        var filterDiv = fixture.debugElement.query(By.css('.ui-dropdown-filter-container'));
        expect(filterDiv).toBeTruthy();
        var filterInputEl = fixture.debugElement.query(By.css('.ui-dropdown-filter'));
    ...
    it('should filtered and display not found warning', async(function () {
        dropdown.options = [
            { label: 'New York', code: 'NY' },
            { label: 'Rome', code: 'RM' },
            { label: 'London', code: 'LDN' },
    ...
    it('should groupSelect with down key', function () {
        ...
        var inputEl = groupFixture.debugElement.query(By.css('input')).nativeElement;
        var keydownEvent = document.createEvent('CustomEvent');
        keydownEvent.which = 40;
        keydownEvent.initEvent('keydown', true, true);
        inputEl.dispatchEvent(keydownEvent);
