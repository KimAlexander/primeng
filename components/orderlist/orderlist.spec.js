...
describe('OrderList', function () {
    ...
    it('should created by default', function () {
        ...
        var orderListEl = fixture.debugElement.query(By.css('div'));
        var controlEls = fixture.debugElement.query(By.css('.ui-orderlist-controls'));
        var containerEl = fixture.debugElement.query(By.css('.ui-orderlist-list-container'));
    ...
    it('should show filter input', function () {
        ...
        fixture.detectChanges();
        var filterInputEl = fixture.debugElement.query(By.css('.ui-inputtext'));
    ...
    it('should add droppoints when dragdrop is enabled', function () {
        ...
        fixture.detectChanges();
        var dragdropEl = fixture.debugElement.query(By.css('.ui-orderlist-droppoint'));
        expect(dragdropEl).toBeTruthy();
    });
    it('should show items', function () {
        fixture.detectChanges();
        var itemListEl = fixture.debugElement.query(By.css('ul'));
    ...
    it('should have selections by default', function () {
        ...
        fixture.detectChanges();
        var itemListEl = fixture.debugElement.query(By.css('ul'));
        var bmwEl = itemListEl.queryAll(By.css('.ui-orderlist-item'))[3];
        fixture.detectChanges();
    ...
    it('should call moveUp', function () {
        ...
        var itemListEl = fixture.debugElement.query(By.css('ul'));
        var bmwEl = itemListEl.queryAll(By.css('.ui-orderlist-item'))[3];
        var buttonsEl = fixture.debugElement.queryAll(By.css('button'));
    ...
    it('should show filter items by default', function () {
        ...
        fixture.detectChanges();
        var filterEl = fixture.debugElement.query(By.css('input'));
        fixture.detectChanges();
        var itemsEl = fixture.debugElement.queryAll(By.css(".ui-orderlist-item"));
    ...
    it('should not onReorder first item to top', function () {
        ...
        orderlist.onReorder.subscribe(function (value) { return data = value; });
        var itemListEl = fixture.debugElement.query(By.css('ul'));
        var vwEl = itemListEl.queryAll(By.css('.ui-orderlist-item'))[0];
        var buttonsEl = fixture.debugElement.queryAll(By.css('button'));
        var moveTopButtonEl = buttonsEl[1];
    ...
    it('should not onReorder first item to bottom', function () {
        ...
        orderlist.onReorder.subscribe(function (value) { return data = value; });
        var itemListEl = fixture.debugElement.query(By.css('ul'));
        var bmwEl = itemListEl.queryAll(By.css('.ui-orderlist-item'))[9];
        var buttonsEl = fixture.debugElement.queryAll(By.css('button'));
        var moveBottomButtonEl = buttonsEl[3];
        bmwEl.nativeElement.click();
        moveBottomButtonEl.nativeElement.click();
    ...
    it('should select item with keyboard navigation', function () {
        ...
        fixture.detectChanges();
        var itemListEl = fixture.debugElement.query(By.css('ul'));
        var bmwEl = itemListEl.queryAll(By.css('.ui-orderlist-item'))[3].nativeElement;
