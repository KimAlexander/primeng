...
describe('PickList', function () {
    ...
    it('should created by default', function () {
        ...
        var picklistEl = fixture.debugElement.query(By.css('div'));
        var controlEls = fixture.debugElement.queryAll(By.css('.ui-picklist-buttons'));
        var wraperEl = fixture.debugElement.queryAll(By.css('.ui-picklist-listwrapper'));
        var contentEl = fixture.debugElement.query(By.css('.ui-widget-content'));
    ...
    it('should show sourceHeader and targetHeader', function () {
        ...
        fixture.detectChanges();
        var headerEls = fixture.debugElement.queryAll(By.css('.ui-picklist-caption'));
    ...
    it('should responsive', function () {
        ...
        fixture.detectChanges();
        var headerEls = fixture.debugElement.query(By.css('div'));
    ...
    it('should show filter input', function () {
        ...
        fixture.detectChanges();
        var filterContainers = fixture.debugElement.queryAll(By.css('.ui-picklist-filter-container'));
    ...
    it('should filtered source', function () {
        picklist.filterBy = "brand";
        fixture.detectChanges();
        var sourceFilterEl = fixture.debugElement.query(By.css('input'));
        sourceFilterEl.nativeElement.value = "v";
        sourceFilterEl.nativeElement.dispatchEvent(new Event('keyup'));
        fixture.detectChanges();
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
    ...
    it('should filtered target', function () {
        picklist.filterBy = "brand";
        fixture.detectChanges();
        var controlAllRightButton = fixture.debugElement.queryAll(By.css('.ui-picklist-buttons-cell'))[1].queryAll(By.css('button'))[1];
        controlAllRightButton.nativeElement.click();
        fixture.detectChanges();
        var targetFilterEl = fixture.debugElement.queryAll(By.css('input'))[1];
        targetFilterEl.nativeElement.value = "v";
        targetFilterEl.nativeElement.dispatchEvent(new Event('keyup'));
        fixture.detectChanges();
        var targetListItems = fixture.debugElement.query(By.css('.ui-picklist-target-wrapper')).queryAll(By.css('.ui-picklist-item'));
    ...
    it('should use input placeholders', function () {
        ...
        fixture.detectChanges();
        var headerEls = fixture.debugElement.queryAll(By.css('.ui-picklist-filter'));
        expect(headerEls.length).toEqual(2);
    ...
    it('should not show filter input', function () {
        ...
        fixture.detectChanges();
        var headerEls = fixture.debugElement.queryAll(By.css('.ui-picklist-filter-container'));
        var inputEls = fixture.debugElement.query(By.css('.ui-picklist-filter'));
    ...
    it('should show items', function () {
        ...
        fixture.detectChanges();
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-droppoint'));
        var targetListItems = fixture.debugElement.query(By.css('.ui-picklist-target-wrapper')).queryAll(By.css('.ui-picklist-droppoint'));
    ...
    it('should change sourceStyle and targetStyle', function () {
        ...
        fixture.detectChanges();
        var headerEls = fixture.debugElement.queryAll(By.css('.ui-widget-content.ui-picklist-list'));
    ...
    it('should not show controls', function () {
        ...
        fixture.detectChanges();
        var sourceControlsEl = fixture.debugElement.query(By.css('.ui-picklist-source-controls'));
        var targetControlsEl = fixture.debugElement.query(By.css('.ui-picklist-target-controls'));
        var listwrapperEls = fixture.debugElement.queryAll(By.css('.ui-picklist-listwrapper'));
    ...
    it('should disabled', function () {
        ...
        picklist.filterBy = "brand";
        fixture.detectChanges();
        var buttonsEls = fixture.debugElement.queryAll(By.css('button'));
        var inputEls = fixture.debugElement.queryAll(By.css('input'));
        var itemEls = fixture.debugElement.queryAll(By.css('li'));
    ...
    it('should call moveUp', function () {
        ...
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var sourceControlUpButton = fixture.debugElement.query(By.css('.ui-picklist-source-controls')).queryAll(By.css('button'))[0];
        sourceListItems[3].nativeElement.click();
        fixture.detectChanges();
        sourceControlUpButton.nativeElement.click();
        fixture.detectChanges();
        var sourceListItemsAfterChange = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
    ...
    it('should call moveDown', function () {
        ...
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var sourceControlDownButton = fixture.debugElement.query(By.css('.ui-picklist-source-controls')).queryAll(By.css('button'))[2];
        sourceListItems[3].nativeElement.click();
        fixture.detectChanges();
    ...
    it('should call movetop', function () {
        ...
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var sourceControlTopButton = fixture.debugElement.query(By.css('.ui-picklist-source-controls')).queryAll(By.css('button'))[1];
        sourceListItems[3].nativeElement.click();
        fixture.detectChanges();
    ...
    it('should call moveBottom', function () {
        ...
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var sourceControlBottomButton = fixture.debugElement.query(By.css('.ui-picklist-source-controls')).queryAll(By.css('button'))[3];
        sourceListItems[3].nativeElement.click();
        fixture.detectChanges();
    ...
    it('should call moveRight', function () {
        ...
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var controlRightButton = fixture.debugElement.queryAll(By.css('.ui-picklist-buttons-cell'))[1].queryAll(By.css('button'))[0];
        sourceListItems[3].nativeElement.click();
        fixture.detectChanges();
        controlRightButton.nativeElement.click();
        fixture.detectChanges();
        var sourceListItemsAfterChange = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var targetListItemsAfterChange = fixture.debugElement.query(By.css('.ui-picklist-target-wrapper')).queryAll(By.css('.ui-picklist-item'));
    ...
    it('should call moveLeft', function () {
        ...
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-source-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var controlRightButton = fixture.debugElement.queryAll(By.css('.ui-picklist-buttons-cell'))[1].queryAll(By.css('button'))[0];
        var controlLeftButton = fixture.debugElement.queryAll(By.css('.ui-picklist-buttons-cell'))[1].queryAll(By.css('button'))[2];
        sourceListItems[3].nativeElement.click();
        fixture.detectChanges();
        controlRightButton.nativeElement.click();
        fixture.detectChanges();
    ...
    it('should call moveAllLeft', function () {
        ...
        var controlAllRightButton = fixture.debugElement.queryAll(By.css('.ui-picklist-buttons-cell'))[1].queryAll(By.css('button'))[1];
        var controlAllLeftButton = fixture.debugElement.queryAll(By.css('.ui-picklist-buttons-cell'))[1].queryAll(By.css('button'))[3];
        fixture.detectChanges();
        controlAllRightButton.nativeElement.click();
        fixture.detectChanges();
    ...
    it('should listen onTargetReorder', function () {
        ...
        var sourceListItems = fixture.debugElement.query(By.css('.ui-picklist-target-wrapper')).queryAll(By.css('.ui-picklist-item'));
        var sourceControlUpButton = fixture.debugElement.query(By.css('.ui-picklist-target-controls')).queryAll(By.css('button'))[0];
        sourceListItems[3].nativeElement.click();
        fixture.detectChanges();
        sourceControlUpButton.nativeElement.click();
        fixture.detectChanges();
