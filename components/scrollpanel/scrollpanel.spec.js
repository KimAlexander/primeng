...
describe('ScrollPanel', function () {
    ...
    it('should created by default', function () {
        ...
        var scrollPanelEl = fixture.debugElement.query(By.css('.ui-scrollpanel'));
        expect(scrollPanelEl.nativeElement).toBeTruthy();
    });
    it('should scroll when mousedown and move (y)', fakeAsync(function () {
        fixture.detectChanges();
        var scrollTopVal = scrollpanel.contentViewChild.nativeElement.scrollTop;
        var barYEl = fixture.debugElement.query(By.css('.ui-scrollpanel-bar-y'));
    ...
    it('should scroll when mousedown and move (x)', fakeAsync(function () {
        fixture.detectChanges();
        var scrollLeftVal = scrollpanel.contentViewChild.nativeElement.scrollLeft;
        var barXEl = fixture.debugElement.query(By.css('.ui-scrollpanel-bar-x'));
        var mousedownEvent = document.createEvent('CustomEvent');
    ...
    it('should scroll with scrollTop', fakeAsync(function () {
        fixture.detectChanges();
        var scrollTopVal = scrollpanel.contentViewChild.nativeElement.scrollTop;
