(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('primeng/dom'), require('primeng/paginator'), require('primeng/api'), require('primeng/utils'), require('@angular/cdk/scrolling'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('primeng/treetable', ['exports', '@angular/core', '@angular/common', 'rxjs', 'primeng/dom', 'primeng/paginator', 'primeng/api', 'primeng/utils', '@angular/cdk/scrolling', 'rxjs/operators'], factory) :
    (global = global || self, factory((global.primeng = global.primeng || {}, global.primeng.treetable = {}), global.ng.core, global.ng.common, global.rxjs, global.primeng.dom, global.primeng.paginator, global.primeng.api, global.primeng.utils, global.ng.cdk.scrolling, global.rxjs.operators));
}(this, (function (exports, core, common, rxjs, dom, paginator, api, utils, scrolling, operators) { 'use strict';
    ...
    var CdkVirtualScrollViewportPatchDirective = /** @class */ (function () {
        ...
        CdkVirtualScrollViewportPatchDirective.prototype.ngOnInit = function () {
            ...
            rxjs.fromEvent(window, 'resize')
                .pipe(operators.debounceTime(10), operators.takeUntil(this.destroy$))
        ...
        CdkVirtualScrollViewportPatchDirective.ctorParameters = function () { return [
            { type: scrolling.CdkVirtualScrollViewport, decorators: [{ type: core.Self }, { type: core.Inject, args: [scrolling.CdkVirtualScrollViewport,] }] }
        ]; };
        CdkVirtualScrollViewportPatchDirective = __decorate([
            core.Directive({
                selector: 'cdk-virtual-scroll-viewport'
            }),
            __param(0, core.Self()), __param(0, core.Inject(scrolling.CdkVirtualScrollViewport))
    ...
    var TreeTableModule = /** @class */ (function () {
        ...
        TreeTableModule = __decorate([
            core.NgModule({
                ...
                exports: [TreeTable, api.SharedModule, TreeTableToggler, TTSortableColumn, TTSortIcon, TTResizableColumn, TTRow, TTReorderableColumn, TTSelectableRow, TTSelectableRowDblClick, TTContextMenuRow, TTCheckbox, TTHeaderCheckbox, TTEditableColumn, TreeTableCellEditor, scrolling.ScrollingModule, CdkVirtualScrollViewportPatchDirective],
